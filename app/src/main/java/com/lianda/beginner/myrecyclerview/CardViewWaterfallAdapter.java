...
public class CardViewWaterfallAdapter extends RecyclerView.Adapter<CardViewWaterfallAdapter.CardViewViewHolder>{

    private ArrayList<Waterfall>listWaterfall;
    private Context context;

    public CardViewWaterfallAdapter (Context context){
    ...
    public void onBindViewHolder(CardViewViewHolder holder, int position) {
       Waterfall p = getListWaterfall().get(position);
        holder.imgPhoto.setImageResource(p.getPhoto());
        ...
        holder.btnFavorite.setOnClickListener(new CustomOnItemClickListener(position, new CustomOnItemClickListener.OnItemClickCallback()
        {
            ...
            public void onItemClicked(View view, int position) {
                Toast.makeText(context, "Favorite "+getListWaterfall().get(position).getName(), Toast.LENGTH_SHORT).show();
            }
        }));
        ...
        holder.btnShare.setOnClickListener(new CustomOnItemClickListener(position, new CustomOnItemClickListener.OnItemClickCallback() {
            ...
            @Override
            public void onItemClicked(View view, int position) {
                Toast.makeText(context, "Share " + getListWaterfall().get(position).getName(), Toast.LENGTH_SHORT).show();
            }
        }));
    }
